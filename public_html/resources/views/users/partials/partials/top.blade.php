               ...
               <div class="social-icon">
                  <ul>
                     ...
                     <li><a class="icon last_icon btn text-white" href="{{route('dashboard')}}" style="background-color:#00a0e3;">
                        <i class="fas fa-user-circle"></i><font class="mbhidden">{{ substr(auth()->user()->name??'', 0, 11) }} </font></a>
                     </li>
                     @endguest
                  </ul>
               </div>
         ...
         <div class="header-bottom-area">
            ...
            <nav class="navbar navbar-area navbar-expand-lg style-02">
               <div class="container-fluid nav-container dsktop_right_pad">
                  <button class="navbar-toggler" style="width: 100%;" type="button" data-toggle="collapse"
                                 ...
                                 <div class="row plr8">
                                    <div class="col-md-9 col-sm-9 col-9 plr8 lefft_sidde">
                                       ...
                                       <div class="epayment-tab">
                                          ...
                                          @php $acat++ @endphp
                                          <div class="epayment-tab-content @if($acat==11) active @endif">
                                             <h5 class="ashdngs">
                  ...
                  <div class="nav-right-content black">
                     <div class="d-flex">
                        <ul>
                           ...
                           <li class="cart" style="margin-right: 30px !important;">
                              <a href="{{ route('cart') }}" class="notification">
                              <i class="fa fa-shopping-cart"></i>
                              <span class="badge totalCartItems">{{ \Cart::content()->count() }}</span>
                              </a>
                           </li>
                        </ul>
                     </div>
