...
<div class="product-meta">
   ...
   <span class="name"><a href="#" data-toggle="modal" data-target="#discount_popup" style="color: #d97706; font-weight: 700; background: #fef3c7; border: 1px dashed #fcd34d; padding: 2px 8px; border-radius: 4px; text-decoration: none;">Details <i class="fa fa-info-circle" style="font-size: 0.85em; margin-left: 2px;"></i></a></span>
</div>
<style type="text/css">
   tr,th{
   font-size:12px;
