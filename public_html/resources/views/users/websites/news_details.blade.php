...
<div class="cstm_page_section" style="background:#ffffff;">
   <div class="blog-page-content">
      <div class="container-fluid">
         <div class="brdcrm_menu" style="margin-top: 5px !important;"><a href="{{route('news', ['url_key'=>'news'])}}"><i class="fas fa-chevron-left"></i>Back to Media List</a></div>
         <div class="row">
            <div class="col-lg-8">
                  ...
                  <div class="widget-area">
                     ...
                     <div class="widget widget_recent_posts style-01">
                        ...
                        <ul class="recent_post_item">
                           ...
                           @foreach($getNewsList->sortByDesc('id')->take(3) as $blog)
                           <li class="single-recent-post-item">
                              <div class="thumb">
                                 <img src="{{url($blog['image'])}}" alt="{{$blog['title']}}" title="{{$blog['title']}}">
                              </div>
                              <div class="content">
                                 <h5 class="title"><a href="{{route('news', $blog->url_key)}}">{{substr($blog['name'], 0,40)}}...</a></h5>
