      ...
      <div class="d-flex align-items-end row">
         <div class="col-lg-6">
            <div class="card-body text-center">
               ...
               <a href="{{ route('enquiries.import_enquiries', ['export'=>'export']) }}" class="btn btn-sm btn-label-primary">Download template</a>
            </div>
         </div>
         <div class="col-lg-6 text-center text-sm-left">
            <div class="card-body text-center">
               ...
               <form method="POST" action="{{ route('enquiries.import_enquiries') }}" enctype="multipart/form-data">
                  @csrf
