      ...
      <div class="d-flex align-items-end row">
         <div class="col-lg-6">
            <div class="card-body text-center">
               ...
               <a href="{{ route('pincodes.import_pincodes', ['export'=>'export']) }}" class="btn btn-sm btn-label-primary">Download template</a>
            </div>
         </div>
         <div class="col-lg-6 text-center text-sm-left">
            <div class="card-body text-center">
               ...
               <form method="POST" action="{{ route('pincodes.import_pincodes') }}" enctype="multipart/form-data">
                  @csrf
