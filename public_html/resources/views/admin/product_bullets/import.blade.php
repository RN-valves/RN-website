...
@section('seo_title')
<title>Product Bullet Points Imports</title>
@endsection
@section('breadcrumbs')
      ...
      <div class="d-flex align-items-end row">
         <div class="col-lg-6">
            <div class="card-body text-center">
               ...
               <a href="{{ route('productBullets.import_pro_bullet', ['export'=>'export']) }}" class="btn btn-sm btn-info border"> <i class="bx bx-cloud-download"></i> Add New Template</a>
               <a href="{{ route('productBullets.import_pro_bullet', ['update'=>'update']) }}" class="btn btn-sm btn-warning border"> <i class="bx bx-download"></i> Update Template</a>
            </div>
         </div>
         <div class="col-lg-6 text-center text-sm-left">
            <div class="card-body text-center">
               ...
               <form method="POST" action="{{ route('productBullets.import_pro_bullet') }}" enctype="multipart/form-data">
                  @csrf
