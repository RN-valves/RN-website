      ...
      <div class="d-flex align-items-end row">
         <div class="col-lg-6">
            <div class="card-body text-center">
               ...
               <a href="{{ route('customers.import_customers', ['export'=>'export']) }}" class="btn btn-sm btn-info border"> <i class="bx bx-cloud-download"></i> Add New Template</a>
               <a href="{{ route('customers.import_customers', ['update'=>'update']) }}" class="btn btn-sm btn-warning border"> <i class="bx bx-download"></i> Update Template</a>
            </div>
         </div>
         <div class="col-lg-6 text-center text-sm-left">
            <div class="card-body text-center">
               ...
               <form method="POST" action="{{ route('customers.import_customers') }}" enctype="multipart/form-data">
                  @csrf
