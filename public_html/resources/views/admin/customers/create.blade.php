      ...
      <form action="{{ route('customers.store') }}" method="POST" class="row g-3">
         ...
         <div class="col-lg-12 mb-1">
            <label for="select_user" style="width:100%;">
              ...
              <select class="js-example-basic-multiple js-states form-control" id="select_user" name="reporting_ids[]" multiple="">
                  ...
                  <option value="{{ $employees->id }}" {{ (collect(old('reporting_ids'))->contains($employees->id)) ? 'selected':'' }}>{{ $employees->name??'' }} ({{ $employees->mobile??'' }})</option>
                  @endforeach
              </select>
               <x-input-error class="mt-2 error_ipt text-danger" :messages="$errors->get('reporting_ids')" />
            </label>
         </div>
         <div class="col-md-6">
         ...
         <div class="col-md-4">
            <div class="form-group">
               ...
               <x-input-error class="mt-2 error_ipt text-danger" :messages="$errors->get('user_code')" />
            </div>
         </div>
         <div class="col-md-4">
            <div class="form-group">
         ...
         <div class="col-lg-4 mb-3" id="city_group">
            ...
            <x-input-error class="mt-2 error_ipt text-danger" :messages="$errors->get('city_id')" />
         </div>
         <div class="col-lg-4 mb-3" id="city_group">
            <label for="city_id" style="width: 100%">
               Select State
            ...
            <x-input-error class="mt-2 error_ipt text-danger" :messages="$errors->get('state_id')" />
         </div>
         <div class="col-lg-4 mb-3" id="city_group">
            <label for="city_id" style="width: 100%">
               Select Country
            ...
            <x-input-error class="mt-2 error_ipt text-danger" :messages="$errors->get('country_id')" />
         </div>
         <div class="col-12">
            <div class="form-group">
