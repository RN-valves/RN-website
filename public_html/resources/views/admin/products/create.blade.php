...
<div class="card">
   <div class="card-body py-3">
      <div class="col-lg-12">
         ...
         @endif
         <form action="{{ route('products.store') }}" method="POST" accept-charset="utf-8" class="row" enctype="multipart/form-data">
            @csrf
            ...
            <div class="col-lg-3 form-group pt-2">
               <label for="roles_select" style="width:100%;">
                  ...
                  <option value="{{ $color->name??'' }}" @selected(old('color_name', @$product->color)==$color->name??'')>{{ $color->name??'' }}</option>
                  @endforeach
                  </select>
            ...
            <div class="col-md-3 form-group mt-3">
               ...
               <select class="form-control shadow-none @error('is_featured') is-invalid @enderror" name="is_isicertified" id="is_isicertified">
                  <option value="1" @selected(old('is_isicertified',@$product->is_isicertified)==1)>Visible</option>
                  <option value="0" @selected(old('is_isicertified',@$product->is_isicertified)==0)>InVisible</option>
               </select>
            ...
            <div class="col-lg-12 pt-3">
               <div class="table-responsive">
                  <table class="table table-bordered">
                     ...
                     <tr>
                        <td>
                           <input type="number" name="ctn_pcs" value="{{ old('ctn_pcs', @$product->ctn_pcs??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                           <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('ctn_pcs')" />
                        </td>
                        <td>
                           <input type="number" name="mid_ctn_pcs" value="{{ old('mid_ctn_pcs', @$product->mid_ctn_pcs??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                           <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('mid_ctn_pcs')" />
                        </td>
                        <td>
                           <input type="number" name="inner_pcs" value="{{ old('inner_pcs', @$product->inner_pcs??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                        ...
                        <td>
                           <input type="number" step="any" name="product_length" value="{{ old('product_length', @$product->product_length??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                           <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('product_length')" />
                        </td>
                        <td>
                           <input type="number" step="any" name="product_breadth" value="{{ old('product_breadth', @$product->product_breadth??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                     ...
                     <tr>
                        <td>
                           <input type="number" step="any" name="product_height" value="{{ old('product_height', @$product->product_height??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                           <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('product_height')" />
                        </td>
                        <td>
                           <input type="number" step="any" name="only_product_wt_gm" value="{{ old('only_product_wt_gm', @$product->only_product_wt_gm??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                           <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('only_product_wt_gm')" />
                        </td>
                        <td>
                           <input type="number" step="any" name="product_lbh_weight_gm" value="{{ old('product_lbh_weight_gm', @$product->product_lbh_weight_gm??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                           <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('product_lbh_weight_gm')" />
                        </td>
                        <td>
                           <input type="number" step="any" name="mid_ctn_lbh_weight_kg" value="{{ old('mid_ctn_lbh_weight_kg', @$product->mid_ctn_lbh_weight_kg??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                           <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('mid_ctn_lbh_weight_kg')" />
                        </td>
                        <td>
                           <input type="number" step="any" name="master_ctn_lbh_weight_kg" value="{{ old('master_ctn_lbh_weight_kg', @$product->master_ctn_lbh_weight_kg??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
                           <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('master_ctn_lbh_weight_kg')" />
                        </td>
                        <td>
                           <input type="number" name="residential_warranty" value="{{ old('residential_warranty', @$product->residential_warranty??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
            ...
            <div class="col-lg-3 form-group">
               ...
               <input type="number" name="commercial_warranty" value="{{ old('commercial_warranty', @$product->commercial_warranty??0) }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
            ...
            <div class="col-lg-9 form-group">
               ...
               <input type="text" name="video_url" value="{{ old('video_url', @$product->video_url??'') }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
               <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('video_url')" />
            </div>
            <div class="col-lg-4 form-group">
               <label class="mb-1">Amazon Link (Opt)</label>
               <input type="text" name="amazon_link" value="{{ old('amazon_link', @$product->amazon_link??'') }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
               <x-input-error class="mt-2 text-danger error_ipt" :messages="$errors->get('amazon_link')" />
            </div>
            <div class="col-lg-4 form-group">
               <label class="mb-1">Flipkart Link (Opt)</label>
               <input type="text" name="flipkart_link" value="{{ old('flipkart_link', @$product->flipkart_link??'') }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
            ...
            <div class="col-lg-4 form-group">
               ...
               <input type="text" name="short_description" value="{{ old('short_description', @$product->short_description??'') }}" class="form-control shadow-none" placeholder="Enter Value" autocomplete="off">
