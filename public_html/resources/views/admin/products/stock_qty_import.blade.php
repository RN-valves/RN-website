...
@section('seo_title')
<title>Stocks Qty Imports</title>
@endsection
@section('breadcrumbs')
      ...
      <div class="d-flex align-items-end row">
         <div class="col-lg-6">
            <div class="card-body text-center">
               ...
               <a href="{{ route('products.import.qty', ['export'=>'export']) }}" class="btn btn-sm btn-info border"> <i class="bx bx-cloud-download"></i> Add New Template</a>
            </div>
         </div>
         <div class="col-lg-6 text-center text-sm-left">
            <div class="card-body text-center">
               ...
               <form method="POST" action="{{ route('products.import.qty') }}" enctype="multipart/form-data">
                  @csrf
